...
struct tipo_celdaOperadores {
    tipoelemPilaOperadores elemento;
    struct tipo_celdaOperadores * sig;
};

typedef struct tipo_celdaOperadores * pilaOperadores;
/////////////////////////////////////////////////////////
...
void pushOperadores(pilaOperadores *P, tipoelemPilaOperadores E) {
    pilaOperadores aux;
    aux = (pilaOperadores) malloc(sizeof (struct tipo_celdaOperadores));
    aux->elemento = E;
    aux->sig = *P;
    *P = aux;
}
